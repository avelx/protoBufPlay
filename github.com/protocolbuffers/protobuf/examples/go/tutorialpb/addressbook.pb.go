...
const file_addressbook_proto_rawDesc = "" +
	"\n" +
	"\x11addressbook.proto\x12\btutorial\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x02\n" +
	"\x06Person\x12\x12\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x1a.tutorial.Person.PhoneTypeR\x04type\"+\n" +
	"\tPhoneType\x12\n" +
	"\n" +
	...
	"\x04WORK\x10\x02\"7\n" +
	"\vAddressBook\x12(\n" +
	"\x06people\x18\x01 \x03(\v2\x10.tutorial.PersonR\x06peopleB\x95\x01\n" +
	"\x1bcom.example.tutorial.protosB\x11AddressBookProtosP\x01Z:github.com/protocolbuffers/protobuf/examples/go/tutorialpb\xaa\x02$Google.Protobuf.Examples.AddressBookb\x06proto3"
